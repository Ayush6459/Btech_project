...
def tsp_dynamic(num_cities):
    def solve_tsp_dynamic(cities):
        ...
        for m in range(2, len(cities)):
            ...
            cities_a = cities_b
        res = min([(cities_a[d][0] + distance_matrix[0][d[1]],
...
def tsp_genetic(num_cities):
    ...
    cities = read_cities(num_cities)
    genetic_algorithm = GeneticAlgorithm(cities=cities, iterations=500, population_size=100,
...
if __name__ == '__main__':
    ...
    for i in num_cities:
        ...
        tsp_dynamic(i)
        end_time1=timer()
        time_taken_DP.append(end_time1-start_time1)
        start_time2=timer()
        tsp_genetic(i)
        end_time2=timer()
        time_taken_Genetic.append(end_time2-start_time2)
    ...
    plt.plot(num_cities,time_taken_DP,label='time_vs_input_size_DP')
    plt.plot(num_cities,time_taken_Genetic,label='time_vs_input_size_genetic')
